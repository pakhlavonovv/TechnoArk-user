  ...
  *Fikir/Izoh:* ${message}
  ...
  `;
    ...
    try {
      ...
      if (data.ok) {
        alert('Mahsulot muvaffaqitatli buyurtma qilindi!');
        setName('');
        setSurname('');
        setPhone('');
        setEmail('');
  ...
  return (
    <div className="container">
      <div className="flex flex-col gap-1">
        <h1 className="text-[#B6BABF]">Bosh sahifa / Savat /</h1>
        <h2 className="text-[35px] font-bold mt-4">Sizning ma`lumotlarinigiz</h2>
        <p className="text-[18px] text-[#B6BABF]">
          Bizning mahsulotimiz haqidagi fikir mulohazalaringiz bilan bo‘lishing yoki izohlar maydonida o‘zingizni qiziqtirgan savolingizni yo‘llang
        </p>
      </div>
