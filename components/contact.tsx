...
const Contact = () => {
  return (
    <div className='container'>
        ...
        <p className='text-[18px] text-[#B6BABF]'>Bizning ishimiz haqidagi fikir mulohazalaringiz bilan bo’lishing yoki izohlar maydonida o’zingizni qiziqtirgan savolingizni yo’llang</p>
        </div>
        <form className='grid grid-cols-1 gap-2 mt-11 md:grid-cols-2 lg:w-[60%]'>
            ...
            <button className='w-full mt-5 bg-[#15509E] border-[1px] border-[#15509E] h-[42px] rounded-md text-white lg:w-[300px] hover:bg-transparent hover:text-[#15509E]'>Yuborish</button>
    </div>
  )
}
